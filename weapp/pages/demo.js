...
_core["default"].page({
...
}, {info: {"components":{"panel":{"path":"./../components/panel"},"counter":{"path":"./../components/counter"},"group":{"path":"./../components/group"},"list":{"path":"./../components/list"},"slide-view":{"path":"./../$vendor/_miniprogram-slide-view@0.0.3@miniprogram-slide-view/miniprogram_dist/index"}},"on":{"8-31":["index-emit"]}}, handlers: {'8-24': {"tap": function proxy () {
  ...
  }},'8-31': {"index-emit": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
